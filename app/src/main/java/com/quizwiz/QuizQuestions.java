...
public class QuizQuestions extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActionBar("Single Player Quiz");
        ...
        public void run() {
            if (timerVal==0)
            {
                if (correctButton == op1Button) {
                    op1Button.setBackgroundColor(colorGreen);
                } else {
                    op1Button.setBackgroundColor(colorRed);
                }
                if (correctButton == op2Button) {
                    op2Button.setBackgroundColor(colorGreen);
                } else {
                    op2Button.setBackgroundColor(colorRed);
                }
                if (correctButton == op3Button) {
                    op3Button.setBackgroundColor(colorGreen);
                } else {
                    op3Button.setBackgroundColor(colorRed);
                }
                if (correctButton == op4Button) {
                    op4Button.setBackgroundColor(colorGreen);
                } else {
                    op4Button.setBackgroundColor(colorRed);
                }
                answered=true;
                timer.cancel();
    ...
    public void onClickA(View v)
    {
        if(aState==false&&answered==false) {
            if (correctButton == op1Button) {
                ...
                op1Button.setBackgroundColor(colorRed);
                correctButton.setBackgroundColor(colorGreen);
